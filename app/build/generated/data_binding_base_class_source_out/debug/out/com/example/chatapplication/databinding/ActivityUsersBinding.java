...
public final class ActivityUsersBinding implements ViewBinding {
  ...
  @NonNull
  public final ProgressBar usersProgressBar;

  @NonNull
  public final RecyclerView usersRecyclerView;

  private ActivityUsersBinding(@NonNull ConstraintLayout rootView,
      @NonNull AppCompatImageView imageBack, @NonNull TextView selectUser,
      @NonNull TextView textErrorMessage, @NonNull ProgressBar usersProgressBar,
      @NonNull RecyclerView usersRecyclerView) {
    this.rootView = rootView;
    this.imageBack = imageBack;
    this.selectUser = selectUser;
    this.textErrorMessage = textErrorMessage;
    this.usersProgressBar = usersProgressBar;
  ...
  public static ActivityUsersBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.usersProgressBar;
      ProgressBar usersProgressBar = ViewBindings.findChildViewById(rootView, id);
      if (usersProgressBar == null) {
        break missingId;
      }
      ...
      return new ActivityUsersBinding((ConstraintLayout) rootView, imageBack, selectUser,
          textErrorMessage, usersProgressBar, usersRecyclerView);
    }
