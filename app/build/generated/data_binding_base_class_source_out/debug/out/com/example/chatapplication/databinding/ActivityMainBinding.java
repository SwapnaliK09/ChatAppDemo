...
public final class ActivityMainBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView conversionRecyclerView;
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView,
      @NonNull RecyclerView conversionRecyclerView, @NonNull FloatingActionButton fabNewChat,
      @NonNull ImageView imageProfile, @NonNull AppCompatImageView imageSignOut,
      @NonNull ProgressBar progressBar, @NonNull TextView textName) {
    this.rootView = rootView;
    this.conversionRecyclerView = conversionRecyclerView;
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.conversionRecyclerView;
      RecyclerView conversionRecyclerView = ViewBindings.findChildViewById(rootView, id);
      if (conversionRecyclerView == null) {
        break missingId;
      }
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, conversionRecyclerView,
