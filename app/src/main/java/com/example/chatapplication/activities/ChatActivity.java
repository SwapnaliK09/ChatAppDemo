...
import com.example.chatapplication.utilites.Constants;
import com.example.chatapplication.utilites.PreferenceManager;
...
public class ChatActivity extends BaseActivity {
    ...
    private void addConversion(HashMap<String,Object> conversion){
        database.collection(
                Constants.KEY_COLLECTION_CONVERSIONS)
                .add(conversion)
    ...
    private void updateConversion(String message){
        DocumentReference documentReference = database.collection(
                Constants.KEY_COLLECTION_CONVERSIONS).document(conversionId);
